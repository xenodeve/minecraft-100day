...
Minecraft **1.20.1** · Forge **47.4.23** · มอด **115** ตัว
...
- **RAM 8 GB** ให้ Minecraft (115 มอด กินพอสมควร)
...
`MODLIST.md` ที่มากับไฟล์ ลงชื่อมอดทั้ง 115 ตัวพร้อมลิงก์ไปหน้าของคนทำ
