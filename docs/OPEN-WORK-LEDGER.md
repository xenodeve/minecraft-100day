...
| **Candidate A test sequence (`PERF-UPFG-046`)** | 🔴 **UNTRACKED** | needs the GPU fixed, then a baseline | **#109**. The variant is built: `-nvidia-upscaling.zip`. Shader OFF and ON separately, TaCZ artifacts, FG at 2× only. `C-UPFG-01/02/03` are open and unfilled |
